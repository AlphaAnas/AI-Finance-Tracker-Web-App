                  ...
                  <div className="grid grid-cols-3 gap-6">
                    <div className="relative">
                      <select 
                        ...
                        className={`w-full p-3 rounded-lg bg-blue-800/50 border border-blue-400/20 text-white focus:outline-none focus:ring-2 focus:ring-blue-500 appearance-none ${!dob.year ? 'text-blue-300/50' : 'text-white'}`}
                      >
                    ...
                    <div className="relative">
                      <select 
                        ...
                        className={`w-full p-3 rounded-lg bg-blue-800/50 border border-blue-400/20 text-white focus:outline-none focus:ring-2 focus:ring-blue-500 appearance-none ${!dob.month ? 'text-blue-300/50' : 'text-white'}`}
                      >
                    ...
                    <div className="relative">
                      <select 
                        ...
                        className={`w-full p-3 rounded-lg bg-blue-800/50 border border-blue-400/20 text-white focus:outline-none focus:ring-2 focus:ring-blue-500 appearance-none ${!dob.day ? 'text-blue-300/50' : 'text-white'}`}
                      >
